...
public class LanguageModel {
    ...
    public String generate(String initialText, int textLength) {
        // If initial text is shorter than the window length, we can't generate anything
        // further.
        ...
        for (int i = 0; i < textLength; ++i) {
            // Extracts the window from the generated text, which is exactly the last
            // windowLength characters
